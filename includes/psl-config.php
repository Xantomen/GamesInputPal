 ...
 */
define("HOST", "192.254.183.35"); 			// The host you want to connect to. 
define("USER", "xantomen_user"); 			// The database username. 
define("PASSWORD", "testscheme"); 	// The database password. 
define("DATABASE", "xantomen_gamesinputschemer");             // The database name.

define("MAILUSER","gamesinputpal@xantomen.com"); //The user email
define("MAILPASSWORD","gq[a%F&cWg#S"); //The email password
